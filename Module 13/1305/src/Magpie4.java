...
public class Magpie4 {
    ...
    public String getResponse(String statement) {
        ...
        // Responses which require transformations
            ...
            if (type == 0 && position >= 0 && findKeyword(statement, "me", position) >= 0) {
                response = transformYouMeStatement(statement);
            } else if (type == 1 && position >= 0 && findKeyword(statement, "you", position) >= 0) {
    ...
    private String transformIYouStatement(String statement) {
        ...
        int positionOfMe = findKeyword(statement, "you", positionOfI + 1);

        String restOfStatement = statement.substring(positionOfI + 1, positionOfMe).trim();
    ...
    private String getRandomResponse() {
        ...
        responses.add("That's crazy!");
        responses.add("Please tell me more.");

        final int NUMBER_OF_RESPONSES = responses.size();

        double r = Math.random();
        int whichResponse = (int)(r * NUMBER_OF_RESPONSES);
        String response = responses.get(whichResponse);
