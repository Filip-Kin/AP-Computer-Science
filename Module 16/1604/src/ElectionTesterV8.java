...
public class ElectionTesterV8 {
    ...
    public static void deleteByLoc(List<CandidateV2> election, int location) {
        election.remove(location);
    }

    public static void deleteByName(List<CandidateV2> election, String findN) {
        int location = -1;
        int i;
    ...
    public static void main(String args[]) {
        ...
        printResults(election);
        System.out.println("\nTotal number of votes in election: " + getTotal(election));
        System.out.println("\nDeleting Jimmie Cohen: ");
        deleteByName(election, "Jimmie Cohen");
        System.out.println();
        printResults(election);
        System.out.println("\nTotal number of votes in election: " + getTotal(election));
    }
