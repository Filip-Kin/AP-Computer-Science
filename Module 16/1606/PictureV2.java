...
public class Picture extends SimplePicture 
{
  ...
  public void copy(Picture fromPic, 
    ...
    Pixel[][] toPixels = this.getPixels2D();
    Pixel[][] fromPixels = fromPic.getPixels2D();
    for (int fromRow = fromStartRow; fromRow < fromEndRow && fromRow < fromPixels.length; fromRow++) {
      toRow = fromRow - fromStartRow + toStartRow;
      for (int fromCol = fromStartCol; fromCol < fromEndCol && fromCol < fromPixels[0].length; fromCol++) {
        toCol = fromCol - fromStartCol + toStartCol;
        fromPixel = fromPixels[fromRow][fromCol];
        toPixel = toPixels[toRow][toCol];
        toPixel.setColor(fromPixel.getColor());
      }
  ...
  public void myCollage()
  {
    ...
    this.copy(flower2,500,0);
    this.mirrorVertical();
    flower3.keepOnlyGreen();
    this.copy(flower3, 0, 0, 300, 200, 0, 0);
